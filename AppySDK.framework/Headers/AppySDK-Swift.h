...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7AppySDK17APCoolAutomations")
@interface APCoolAutomations : APObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7AppySDK23APCoolAutomationsStatus")
@interface APCoolAutomationsStatus : APBase
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7AppySDK14APDimmerStatus")
...
SWIFT_CLASS("_TtC7AppySDK7APImage")
@interface APImage : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7AppySDK7APLight")
...
SWIFT_CLASS("_TtC7AppySDK6APRoom")
@interface APRoom : APBase
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
